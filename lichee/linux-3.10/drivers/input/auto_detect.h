...
/*
 * auto_detect_info - Record related information of the device
 *
...
/*
 * auto_detect - The information of the device.
 *
 * @info:        auto_detect_info structure.
 * @temp_client: Contain device address of the i2c_client structure.
 * @filp:        Read/write file structure.
 * @name:        para_name auto_detect_info.
...
/*
 *
 * auto_detect_name - The information of the device.
 *
...
struct auto_detect_getted_flag {
	int	g_getted_flag;
	int	c_getted_flag;
	int	gy_getted_flag;
	int	ls_getted_flag;
