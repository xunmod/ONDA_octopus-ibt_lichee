...
struct gslX680_fw_array {
	...
	{"gslX680_n106"  ,  ARRAY_SIZE(AW_GSL3692_19201080_N106_FW), AW_GSL3692_19201080_N106_FW},
	{"gslX680_u708"  ,  ARRAY_SIZE(U78_GSL1686F_1024600_PG_QCY070157), U78_GSL1686F_1024600_PG_QCY070157},
};

unsigned int *gslX680_config_data[19] = {
	...
	gsl_config_data_id_AW_GSL3692_19201080_N106,
	gsl_config_data_id_U78_GSL1686F_1024600_PG_QCY070157,
};
...
/* default:static var is initialised to 0 */
...
static void process_gslX680_data(struct gsl_ts *ts)
{
	...
	input_report_key(ts->input, BTN_TOUCH, (touches || key_value));
#endif
