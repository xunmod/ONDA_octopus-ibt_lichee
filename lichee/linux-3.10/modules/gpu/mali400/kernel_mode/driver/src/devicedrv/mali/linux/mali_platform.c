 ...
 ****************************************************************
 */
static int scene_ctrl_status_show(struct device *dev,
 ...
 ****************************************************************
 */
static int scene_ctrl_status_store(struct device *dev,
					struct device_attribute *attr,
 ...
 ****************************************************************
 */
static int scene_ctrl_cmd_show(struct device *dev,
					struct device_attribute *attr,
					char *buf)
{
 ...
 ****************************************************************
 */
static int scene_ctrl_cmd_store(struct device *dev,
				struct device_attribute *attr,
				const char *buf, int count)
{
	int err, level_to_be;
