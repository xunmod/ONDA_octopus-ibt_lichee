...
static int disp_de_enable(void)
{
	writel(0x00000001,0x01000000);
	writel(0x00000001,0x01000004);
	writel(0x00000001,0x01000008);
	return 0;
}
#endif
