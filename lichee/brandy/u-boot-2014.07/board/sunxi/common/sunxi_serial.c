...
#else
    sunxi_soc_chipid[0] = smc_readl(SUNXI_SID_BASE);
	sunxi_soc_chipid[1] = smc_readl(SUNXI_SID_BASE + 0x4);
	sunxi_soc_chipid[2] = smc_readl(SUNXI_SID_BASE + 0x8);
	sunxi_soc_chipid[3] = smc_readl(SUNXI_SID_BASE + 0xc);
