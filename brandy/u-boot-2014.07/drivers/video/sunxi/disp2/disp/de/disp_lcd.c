...
static s32 lcd_clk_config(struct disp_device* lcd)
{
	...
	u32 pll_video0_freq = 840;
	u32 div_factor = 0;
	u32 dsi_div = 0;

	if(sys_cfg_lcd_dclk != 0)
		div_factor = (u32)(pll_video0_freq / sys_cfg_lcd_dclk) - 1;

	dsi_div = (0x80000000 | div_factor);
	writel(dsi_div,0x01c20168);
	writel(0x80000000,0x01c2016c);
#endif
